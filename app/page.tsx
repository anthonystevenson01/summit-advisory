...
export default function Home() {
  return (
    <div className="min-h-screen scroll-smooth relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex-shrink-0">
              <Link href="/" className="flex items-center gap-2 text-2xl font-bold text-[#1e3a8a] hover:text-[#1e40af] transition-colors">
                <svg className="w-7 h-7 text-[#1e3a8a]" fill="currentColor" viewBox="0 0 24 24" stroke="#1e3a8a" strokeWidth={2}>
      ...
      <section className="pt-32 pb-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-white/25 backdrop-blur-lg rounded-2xl p-10 sm:p-12 inline-block shadow-xl">
      ...
      <section id="services" className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white/30 backdrop-blur-xl rounded-2xl border border-white/40 shadow-2xl p-10 sm:p-12">
              <h2 className="text-5xl sm:text-6xl font-bold text-center text-gray-900 leading-tight mb-16">
                Where We Can Help
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
              {/* Service Card 1 */}
              <div className="p-8 rounded-xl border border-white/30 hover:bg-white/20 transition-all duration-300">
                ...
                <h3 className="text-2xl font-semibold mb-4 text-gray-900">Growth Strategy & Execution</h3>
              ...
              <div className="p-8 rounded-xl border border-white/30 hover:bg-white/20 transition-all duration-300">
                ...
                <h3 className="text-2xl font-semibold mb-4 text-gray-900">Market Entrance & Expansion</h3>
                <p className="text-slate-700 leading-relaxed text-lg">
              ...
              <div className="p-8 rounded-xl border border-white/30 hover:bg-white/20 transition-all duration-300">
                ...
                <h3 className="text-2xl font-semibold mb-4 text-gray-900">Sales Team Building & Deal Closing</h3>
                <p className="text-slate-700 leading-relaxed text-lg">
            ...
            <div className="bg-white/30 backdrop-blur-xl rounded-2xl border border-white/40 shadow-2xl p-10 sm:p-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
                ...
                <div className="p-8 rounded-xl border border-white/30 hover:bg-white/20 transition-all duration-300 text-center">
                  ...
                  <h3 className="text-2xl font-semibold mb-4 text-gray-900">C-Suite Experience, Fractional Cost</h3>
                  <p className="text-slate-700 leading-relaxed text-lg">
                ...
                <div className="p-8 rounded-xl border border-white/30 hover:bg-white/20 transition-all duration-300 text-center">
                  ...
                  <h3 className="text-2xl font-semibold mb-4 text-gray-900">Hands-On, Not Just Advisory</h3>
                  <p className="text-slate-700 leading-relaxed text-lg">
                ...
                <div className="p-8 rounded-xl border border-white/30 hover:bg-white/20 transition-all duration-300 text-center">
                  ...
                  <h3 className="text-2xl font-semibold mb-4 text-gray-900">Built for Growing Companies</h3>
                  <p className="text-slate-700 leading-relaxed text-lg">
      ...
      {/* Questions Section */}
      <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl sm:text-5xl font-bold mb-4 text-gray-900 leading-tight">
              Have Questions?
            </h2>
            <p className="text-lg sm:text-xl mb-6 text-slate-700 leading-relaxed">
